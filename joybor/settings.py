...
SECRET_KEY = 'django-insecure-aj$@y4!_+a%&6!zw4ip)*ioz6!e(@&sw0=$y8dagu#0t(0=lxl'
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'in': 'header',
            'name': 'Authorization',
            'description': "Token format: **Bearer &lt;access_token&gt;**"
        }
    },
...
WSGI_APPLICATION = 'joybor.wsgi.application'
...
# MEDIA FILES (User uploads: images, PDFs)
MEDIA_URL = '/media/'
